...
const raw = [
  ...
  },
  {
    ...
    coachedLine: [
      { ball: "r1", strength: "medium", spin: "low", why: "Start at the baulk end where the white already is — screw back so you stay there." },
